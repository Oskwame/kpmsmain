...
const TabComponent = () => {
    ...
    const tabs = [
        { id: 'tab1', label: 'Civil Eng' },
        { id: 'tab2', label: 'Mechanical Eng' },
        { id: 'tab3', label: 'Automotive Eng' },
        { id: 'tab4', label: 'Electrical/Electronics Eng' },
        { id: 'tab5', label: 'Energy Systems Eng' },
    ];
